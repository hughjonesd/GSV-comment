...
# NB: you can't do this within binder AFAIK
rerun_java <- FALSE
...
suppressMessages(source("bayesian-heads-cts.R"))
source("GSV-heads.R")
...
confidence level, with more than 90/95/99% of intervals containing the true value of $\lambda$. The
...
for *N* of 10 and 50. The Bayesian method is best for all values of $\lambda$ up to 80%.
