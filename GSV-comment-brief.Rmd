...
link-citations: yes
abstract: |
  Garbarino, Slonim and Villeval (2018) describe a new method to calculate the probability distribution   of the number of liars in "coin flip" style experiments. However, their method gives 
...
3. If your N is too small for point 2 to apply, it may be too small, since results will 
  depend on methods used and on one's priors.
